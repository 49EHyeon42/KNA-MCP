...
// UseCases contains the national standard insect list use cases exposed as MCP tools.
type UseCases struct {
	ScnmSearch inbound.ScnmSearchUseCase
}

// AddTools adds all national standard insect list tools to an MCP server.
