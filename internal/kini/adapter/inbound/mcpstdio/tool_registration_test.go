...
func TestAddToolsRegistersAllKiniTools(t *testing.T) {
	...
	if len(result.Tools) != 1 || result.Tools[0].Name != "kini_scnm_search" {
		t.Fatalf("tools = %#v, want kini_scnm_search", result.Tools)
	}
