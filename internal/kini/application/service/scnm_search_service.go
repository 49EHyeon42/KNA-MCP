...
// ScnmSearchService runs the insect scientific name list use case.
type ScnmSearchService struct {
	port outbound.ScnmSearchPort
}

// NewScnmSearchService creates an insect scientific name list service.
func NewScnmSearchService(port outbound.ScnmSearchPort) *ScnmSearchService {
	return &ScnmSearchService{port: port}
}

// ScnmSearch returns insect scientific name information.
