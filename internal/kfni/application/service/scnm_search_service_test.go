...
func TestScnmSearchService(t *testing.T) {
	tests := []struct {
		...
		{name: "valid conditions", query: application.ScnmSearchQuery{PageNo: 1, NumOfRows: 1, ReqGnrlNm: "general name", ReqScnm: "scientific name", DateFrom: "20240101", DateTo: "20241231"}, wantCall: true},
	}
