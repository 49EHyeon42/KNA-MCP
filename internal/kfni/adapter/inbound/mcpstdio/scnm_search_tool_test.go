...
func TestScnmSearchTool(t *testing.T) {
	...
	inputDescriptions := map[string]string{
		...
		"reqGnrlNm": "검색하려는 버섯 국명(버섯명) (부분 문자열 검색)",
		"reqScnm":   "검색하려는 버섯 학명 (대소문자를 구분하지 않는 부분 문자열 검색)",
		"dateFrom":  "최종수정일 이후 정보 (yyyyMMdd)",
		"dateTo":    "최종수정일 이전 정보 (yyyyMMdd)",
	}
	checkToolInputSchema(t, ctx, clientSession, "kfni_scnm_search", inputDescriptions, []string{"pageNo", "numOfRows"})
	checkToolDescription(t, ctx, clientSession, "kfni_scnm_search", "산림청 국립수목원 국가표준버섯목록의 버섯 학명 목록을 검색합니다.")
	...
	itemDescriptions := map[string]string{
		"stpltScnmRltnCdNm": "버섯 학명의 정/이명 구분",
		"classKorNm":        "버섯 분류군  강명의 한국명칭",
		"classNm":           "버섯 분류군의 강명(Class Name)",
		"falmNm":            "버섯 분류군의  과명(family Name)",
		"falnKorNm":         "버섯 분류군  과명의 한국명칭",
		"fngsGnrlNm":        "버섯 국명(버섯명)",
		"fngsScnm":          "버섯 학명",
		"fngsScnmId":        "버섯 학명ID",
		"genusKorNm":        "버섯 분류군  속명의 한국명칭",
		"genusNm":           "버섯 분류군의  속명(Genus Name)",
		"lastUpdtDtm":       "최종 수정일",
		"ordKorNm":          "버섯 분류군  목명의 한국명칭",
		"ordNm":             "버섯 분류군의  목명(Order Name)",
		"phylumKorNm":       "버섯 분류군  문명의 한국명칭",
		"phylumNm":          "버섯 분류군의  문명(Phylum Name)",
	}
	checkToolOutputSchema(t, ctx, clientSession, "kfni_scnm_search", outputDescriptions, itemDescriptions)
